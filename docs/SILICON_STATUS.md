...
| Full test suite | Passing | `236 passed` on 2026-06-20 (214 baseline + 8 tiles + 8 IR-drop/EM + 6 fix-loop) | Real-data tests skip when local gitignored files are absent |
